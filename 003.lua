...
-- Remote สำหรับระบบลบของ (ใช้กับเกมที่คุณเป็นเจ้าของ/มีสิทธิ์แก้ไขเท่านั้น)
local ClearToolsRemote = ReplicatedStorage
    :WaitForChild("RE")
    :WaitForChild("1Clear1rTool1s")
...
MainFrame.Size = UDim2.new(0, 520, 0, 235)
...
-- ระบบปุ่มลบของ
-- ค่า "ClearTools" เป็น protocol ที่ต้องให้ Server ของเกมรองรับ
