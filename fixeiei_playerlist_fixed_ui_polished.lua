...
-- ไม่มีไฟวิ่ง/LED animation เพื่อให้ UI เบาและลื่นขึ้น
-- ==================== FAINT BACKGROUND IMAGE ====================
-- ใช้ภาพเดียวกับปุ่มเปิด UI และทำให้จางมากเพื่อไม่รบกวนการอ่าน
local BackgroundImage = Instance.new("ImageLabel", MainFrame)
BackgroundImage.Name = "FaintBackgroundImage"
BackgroundImage.Size = UDim2.new(1, 0, 1, 0)
BackgroundImage.Position = UDim2.new(0, 0, 0, 0)
BackgroundImage.BackgroundTransparency = 1
BackgroundImage.Image = "rbxassetid://71528188513749"
...
JunkFrame.ZIndex = 10
JunkFrame.ClipsDescendants = true
