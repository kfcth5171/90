-- [[ HONKUKI ULTIMATE LOADER V2 - DIRECT EXECUTE EDITION ]] --
...
-- ==========================================
-- 🟢 ฟังก์ชันรันสคริปต์หลัก (Direct Execution)
-- ==========================================
local function ExecuteMainScript()
    task.spawn(function()
        -- รันสคริปต์ดูดไอดีเพลง By.Honkuki โดยตรง
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        ...
        Text = "ส่งคำสั่งรันสคริปต์เรียบร้อยแล้ว!",
        Duration = 5
    })
end
