...
local RunBtn5 = CreateScriptCard(PageGame, "Clear Tool", "Clear Tool Script", "EXECUTE", false)
...
RunBtn5.MouseButton1Click:Connect(function()
    ExecuteWithCoquetteLoading("https://raw.githubusercontent.com/kfcth5171/90/refs/heads/main/002.lua", "Clear Tool", "Clear Tool")
end)
