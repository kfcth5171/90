...
-- Shadow3D removed: prevents the duplicate-looking black window behind the main UI.

local LEDBorder = Instance.new("Frame", ScreenGui)
LEDBorder.Name = "LEDBorder"
LEDBorder.Size = UDim2.new(0.86, 0, 0.74, 0)
...
local function iconLine(parent, x, y, w, h, rot)
    ...
    line.ZIndex = (parent.ZIndex or 1)
