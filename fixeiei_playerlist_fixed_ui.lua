...
LEDBorder.BackgroundColor3 = Color3.fromRGB(32, 18, 45)
...
-- ==================== SINGLE UI BACKGROUND IMAGE ====================
-- ใช้ภาพเดียวกับปุ่มเปิด UI เป็นพื้นหลังจาง ๆ ภายในหน้าต่างเดียว
local UIBackground = Instance.new("ImageLabel", MainFrame)
UIBackground.Name = "UIBackground"
UIBackground.Size = UDim2.new(1, 0, 1, 0)
UIBackground.Position = UDim2.new(0, 0, 0, 0)
UIBackground.BackgroundTransparency = 1
UIBackground.Image = "rbxassetid://71528188513749"
UIBackground.ImageTransparency = 0.88
UIBackground.ScaleType = Enum.ScaleType.Crop
UIBackground.ZIndex = 4
UIBackground.Active = false
Instance.new("UICorner", UIBackground).CornerRadius = UDim.new(0, 17)

local UIBackgroundGradient = Instance.new("UIGradient", UIBackground)
UIBackgroundGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.10),
    NumberSequenceKeypoint.new(0.5, 0),
    NumberSequenceKeypoint.new(1, 0.18)
}
UIBackgroundGradient.Rotation = 90
...
-- ==================== LOW-OVERHEAD UI ====================
-- ปิด LED runner, particle loops และ RenderStepped เพื่อให้ UI เบาและลื่น
...
local function create3DButton(parent, text, color, iconKind)
    ...
    textPad.PaddingLeft = UDim.new(0, 34)
